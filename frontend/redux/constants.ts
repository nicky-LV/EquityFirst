...
export const SET_INTRADAY_DATA = "SET_INTRADAY_DATA"

import {TIMESCALE_ENUM} from "../ts/types";

export const TIME_SCALE_VALUES = [TIMESCALE_ENUM.DAY, TIMESCALE_ENUM.WEEK, TIMESCALE_ENUM.MONTH, TIMESCALE_ENUM.YEAR]